...
export default class Login extends Component{
            ...
            <AuthLayout
                ...
                body={
                    <View>
                        ...
                        <View style={[styles.inputContainer, {flexBasis: 176}]}>
                            <Kohana
                                iconClass={Ionicons}
                                ...
                                onSubmitEditing={event => this.nameInput.focus()}
                            />
                        ...
                        <CustomButton style={styles.submitButton} onPress={this._handleSubmit.bind(this)} label='register' />
                    </View>
                }
                footer={
                    <TouchableOpacity onPress={() => {this.props.navigator.pop()}}>
                        <Text style={styles.footerText}>already have an account? just login!</Text>
                    </TouchableOpacity>
                }
            />
        );
    ...
    _handleSubmit(){
        if(!this.state.password || !this.state.email || !this.state.name) return false;
